...
from tables import Department, StudentMajor
...
class Major(Base):
    ...
    For instance the CECS department has both a Computer Engineering and
    a Computer Science major."""
    __tablename__ = 'majors'
    department: Mapped[Department] = relationship(back_populates='majors')
    departmentAbbreviation: Mapped[str] = mapped_column(
        'department_abbreviation', ForeignKey('departments.abbreviation'), primary_key=False
    )
    ...
    students: Mapped[list[StudentMajor]] = relationship(
        back_populates='major', cascade='all, save-update, delete-orphan'
    )
    ...
    def __init__(self, department: Department, name, description):
    ...
    def add_student(self, student):
        ...
        _student_major = StudentMajor(student, self, datetime.now())
