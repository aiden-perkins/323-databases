from sqlalchemy import UniqueConstraint, ForeignKeyConstraint, String, Integer
from sqlalchemy.orm import Mapped, mapped_column, relationship

from constants import Base
from tables import Department
...
class Course(Base):
    ...
    def __init__(self, department: Department, course_number, name, description, units) -> None:
