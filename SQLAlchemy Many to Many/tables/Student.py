...
from sqlalchemy import Integer, UniqueConstraint, Identity, String
from sqlalchemy.orm import Mapped, mapped_column, relationship

from constants import Base
from tables import StudentMajor, Enrollment
...
class Student(Base):
    ...
    majors: Mapped[list[StudentMajor]] = relationship(
        back_populates='student', cascade='all, save-update, delete-orphan'
    )
    ...
    def add_major(self, major):
        ...
        _student_major = StudentMajor(self, major, datetime.now())
    ...
    def add_section(self, section):
        for next_section in self.sections:
            if next_section.section == section:
                return
        _enrollment = Enrollment(self, section)
