...
from db_collections import Status, StatusChange
...
class Order(Document):
    ...
    meta = {
        'collection': 'orders',
        'indexes': [{'unique': True, 'fields': ['customerName', 'orderDate'], 'name': 'orders_pk'}]
    }
    ...
    def change_status(self, new_status: StatusChange):
        ...
        if self.statusHistory:
            ...
            if new_status.statusChangeDate > datetime.datetime.now(datetime.UTC):
